...
typedef struct _pgm_struct pgm_node_t;
typedef struct _block_struct block_node_t;
typedef struct _const_dec_struct const_dec_node_t;
typedef struct _const_def_struct const_def_node_t;
typedef struct _var_dec_struct var_dec_node_t;
typedef struct _var_def_struct var_def_node_t;
typedef struct _pf_dec_list_struct pf_dec_list_node_t;
typedef struct _proc_dec_struct proc_dec_node_t;
typedef struct _proc_def_struct proc_def_node_t;
typedef struct _proc_head_struct proc_head_node_t;
typedef struct _fun_dec_struct fun_dec_node_t;
typedef struct _fun_def_struct fun_def_node_t;
typedef struct _fun_head_struct fun_head_node_t;
typedef struct _stmt_struct stmt_node_t;
typedef struct _assign_stmt_struct assign_stmt_node_t;
typedef struct _if_stmt_struct if_stmt_node_t;
typedef struct _repe_stmt_struct repe_stmt_node_t;
typedef struct _for_stmt_struct for_stmt_node_t;
typedef struct _pcall_stmt_struct pcall_stmt_node_t;
typedef struct _fcall_stmt_struct fcall_stmt_node_t;
typedef struct _comp_stmt_struct comp_stmt_node_t;
typedef struct _read_stmt_struct read_stmt_node_t;
typedef struct _write_stmt_struct write_stmt_node_t;
typedef struct _expr_struct expr_node_t;
typedef struct _term_struct term_node_t;
typedef struct _factor_struct factor_node_t;
typedef struct _cond_struct cond_node_t;
typedef struct _ident_struct ident_node_t;
typedef struct _para_list_struct para_list_node_t;
typedef struct _para_def_struct para_def_node_t;
typedef struct _arg_list_struct arg_list_node_t;
