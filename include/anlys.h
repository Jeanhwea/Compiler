...
static syment_t *anlys_proc_head(proc_head_node_t *node);
static void anlys_fun_decf(fun_dec_node_t *node);
static syment_t *anlys_fun_head(fun_head_node_t *node);
...
static syment_t *anlys_expr(expr_node_t *node);
static syment_t *anlys_term(term_node_t *node);
static syment_t *anlys_factor(factor_node_t *node);
static syment_t *anlys_fcall_stmt(fcall_stmt_node_t *node);
static void anlys_cond(cond_node_t *node, syment_t *label);
static void anlys_para_list(para_list_node_t *node);
static void anlys_arg_list(arg_list_node_t *node, syment_t *pfste);
