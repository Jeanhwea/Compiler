...
exe 'vert 1resize ' . ((&columns * 68 + 77) / 155)
exe '2resize ' . ((&lines * 25 + 26) / 52)
exe 'vert 2resize ' . ((&columns * 68 + 77) / 155)
exe 'vert 3resize ' . ((&columns * 86 + 77) / 155)
argglobal
setlocal keymap=
setlocal noarabic
...
silent! normal! zE
let s:l = 49 - ((16 * winheight(0) + 12) / 24)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 45 - ((23 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
45
