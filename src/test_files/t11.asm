...
J_prn_swap$IR$IR:
	...
	push	edi
	mov	esi, [ebp + 20]
	mov	eax, [esi]	; *J_prn_swap$IR$IR_i
	mov	[ebp - 8], eax	; J_prn_swap$IR$IR_temp
	mov	esi, [ebp + 16]
	mov	eax, [esi]	; *J_prn_swap$IR$IR_j
	mov	esi, [ebp + 20]
	mov	[esi], eax	; *J_prn_swap$IR$IR_i
	mov	eax, [ebp - 8]	; J_prn_swap$IR$IR_temp
	mov	esi, [ebp + 16]
	mov	[esi], eax	; *J_prn_swap$IR$IR_j
	pop	edi
	pop	esi
	pop	ebx
	mov	eax, [ebp - 4]
...
..@l7:
	...
	mov	eax, [ebp - 64]	; J_prn_&3
	mov	ecx, 1
	add	eax, ecx
	mov	[ebp - 68], eax	; J_prn_&4
	mov	eax, [ebp - 68]	; J_prn_&4
	...
	mov	ecx, 1
	add	eax, ecx
	mov	[ebp - 72], eax	; J_prn_&5
	mov	eax, [ebp - 72]	; J_prn_&5
	mov	[ebp - 48], eax	; J_prn_i
	mov	eax, [ebp - 48]	; J_prn_i
	lea	edi, [ebp - 8]	; J_prn_he
	imul	eax, 4
