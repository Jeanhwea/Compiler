...
***********************************************************
    ...
    temp   J_prn_swap$IR$IR_temp       5	Var_Obj_t	Int_Type_t      -1       3       0
       i      J_prn_swap$IR$IR_i       4	Para_Ref_Obj_t	Int_Type_t      -1       3       0
       j      J_prn_swap$IR$IR_j       4	Para_Ref_Obj_t	Int_Type_t      -1       3       1
-----------------------------------------------------------
...
***********************************************************
    ...
    swap        J_prn_swap$IR$IR       4	Proc_Obj_t	Nop_Type_t      -1       2      -1
-----------------------------------------------------------
