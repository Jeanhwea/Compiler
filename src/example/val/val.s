...
SECTION .text
	ALIGN 16
	GLOBAL P$PVAL_PVAL$SMALLINT
P$PVAL_PVAL$SMALLINT:
..@c1:
		push	ebp
..@c3:
..@c4:
...
..@c10:
		...
		mov	ax,word [TC_P$PVAL_A]
		call	NEAR P$PVAL_PVAL$SMALLINT
		call	NEAR fpc_get_output
		mov	ebx,eax
		movsx	ecx,word [TC_P$PVAL_A]
		mov	edx,ebx
		mov	eax,0
...
SECTION .data
	ALIGN 4
	GLOBAL THREADVARLIST_P$PVAL
THREADVARLIST_P$PVAL:
	DD	0
...
FPC_THREADVARTABLES	DD	3
	DD	THREADVARLIST_SYSTEM,THREADVARLIST_SI_PRC,THREADVARLIST_P$PVAL
