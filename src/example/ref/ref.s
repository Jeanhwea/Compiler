...
..@c10:
		...
		mov	eax,dword TC_P$REF_A
		call	NEAR P$REF_PREF$SMALLINT
		call	NEAR fpc_get_output
		mov	ebx,eax
		movsx	ecx,word [TC_P$REF_A]
		mov	edx,ebx
		mov	eax,0
...
FPC_THREADVARTABLES	DD	3
	DD	THREADVARLIST_SYSTEM,THREADVARLIST_SI_PRC,THREADVARLIST_P$REF
